...
jQuery( document ).ready(function() {
    ...
    jQuery(".skin-1").on('click', function(){
		...
		jQuery(".logo-header img").attr("src", "images/Big Boy Machines Logo - 2.jpg");
		jQuery(".header-style-1.header-dark-1 .logo-header img").attr("src", "images/Big Boy Machines Logo - 2.jpg");
		jQuery(".footer-dark .logo-footer img").attr("src", "images/Big Boy Machines Logo - 2.jpg");
		jQuery(".footer-light .logo-footer img").attr("src", "images/Big Boy Machines Logo - 2.jpg");
        return false;
    });
